...
parser.add_argument('--svw',     type=float, default=1,         help="Src weight")
parser.add_argument('--smw',     type=float, default=1,         help="Src weight")
parser.add_argument('--tvw',     type=float, default=1e-1,      help="Trg weight")
parser.add_argument('--tcw',     type=float, default=1e-1,      help="Trg weight")
parser.add_argument('--tmw',     type=float, default=1e-1,      help="Trg weight")
