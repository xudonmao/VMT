...
parser.add_argument('--bw',     type=float, default=1e-3,      help="Beta (KL) weight")
...
parser.add_argument('--svw',     type=float, default=1e-2,         help="Src weight")
parser.add_argument('--tvw',     type=float, default=2e-2,      help="Trg weight")
parser.add_argument('--tcw',     type=float, default=2e-2,      help="Trg weight")
parser.add_argument('--smw',     type=float, default=1e-2,         help="Src weight")
parser.add_argument('--tmw',     type=float, default=2e-2,      help="Trg weight")
